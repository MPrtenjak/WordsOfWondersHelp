...
function processWords(language, fileName) {
    const inputFilePath = path.join(__dirname, language, 'src', fileName);
    const outputDir = path.join(__dirname, language);
...
processWords(language, fileName);
